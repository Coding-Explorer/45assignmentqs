...
let message2: string = "With faith, discipline and selfless devotion to duty,there is nothing worthwhile that you cannot achieve."

console.log(`${famous_person} said. "${message2}"`)