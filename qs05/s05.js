...
var message2 = "With faith, discipline and selfless devotion to duty,there is nothing worthwhile that you cannot achieve.";
console.log("".concat(famous_person, " said. \"").concat(message2, "\""));
