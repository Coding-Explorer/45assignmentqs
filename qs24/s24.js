...
var fruits = ["Pineapple", "Strawberry", "Mango", "Peach"];
//• Test whether an item is or not in a array
// Test 1
console.log("• Test whether an item is in a array");
console.log(fruits.some(function (fruit) { return fruit === "Pineapple"; })); // true (because "Grapes" are in the array)
// Test 2
console.log("• Test whether an item is not in a array");
console.log(fruits.some(function (fruit) { return fruit === "pineapple"; })); // false (because "grapes" are not in the array, and some is case-sensitive)
